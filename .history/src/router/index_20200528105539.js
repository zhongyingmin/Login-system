    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'agreement',
          name: 'agreement',
          component: () => import('@/pages/pc/agreement/index')
        },
        {
          path: 'institutions',
          name: 'pc/institutions',
          component: () => import('@/pages/pc/institutions/index')
        },
        {
          path: 'retrieve',
          name: 'retrieve',
          component: () => import('@/pages/mobile/retrieve/index')
        }
      ]
    },
