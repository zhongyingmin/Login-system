          ...
          >
            ...
            >
              <el-form-item label="注册手机号:" prop="phone">
                <el-input type="text" v-model="phoneForm.phone" placeholder="输入注册手机号" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="图形验证码:" prop="Verification_code">
                <el-input type="password" v-model="phoneForm.phone_code" placeholder="验证码" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item>
            ...
            >
              ...
              <el-form-item label="账号:" prop="account">
                <el-input type="text" v-model="artificialForm.account" placeholder="输入手机号/邮箱/用户编号/用户名" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="联系方式:" prop="contact">
                <el-input type="password" v-model="artificialForm.contact" placeholder="输入您的联系方式" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="图形验证码:" prop="artificial_code">
                <el-input type="password" v-model="artificialForm.artificial_code" placeholder="验证码" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item>
            ...
            >
              <el-form-item label="邮箱:" prop="email">
                <el-input type="text" v-model="emailForm.email" placeholder="输入邮箱" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="图形验证码:" prop="email_code">
                <el-input type="password" v-model="emailForm.email_code" placeholder="验证码" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item>
