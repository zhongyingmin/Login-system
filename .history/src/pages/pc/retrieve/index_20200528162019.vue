          ...
          >
            ...
            >
              ...
              <el-form-item label="图形验证码:" prop="Verification_code">
                <el-input type="password" v-model="phoneForm.phone_code" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item>
            ...
            >
              ...
              <el-form-item label="账号:" prop="account">
                <el-input type="text" v-model="artificialForm.account" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="联系方式:" prop="contact">
                <el-input type="password" v-model="artificialForm.contact" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="图形验证码:" prop="artificial_code">
                <el-input type="password" v-model="artificialForm.artificial_code" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item>
            ...
            >
              ...
              <el-form-item label="图形验证码:" prop="email_code">
                <el-input type="password" v-model="emailForm.email_code" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item>
