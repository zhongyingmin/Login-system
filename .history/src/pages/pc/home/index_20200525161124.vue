...
export default {
  ...
  methods: {
    ...
    pswCode() {
      this.pswidentifyCode = "";
      this.pswmakeCode(this.pswidentifyCodes, 4);
    },
    makeCode(o, l) {
      for (let i = 0; i < l; i++) {
        this.pswidentifyCode += this.pswidentifyCodes[
          this.randomNum(0, this.pswidentifyCodes.length)
        ];
      }
