      ...
      <div class="center-wrapper">
        <el-tabs v-model="activeName" @tab-click="handleClick">
                ...
                <el-row :span="24" :gutter="17">
                  <el-col :span="14">
                    <el-checkbox v-model="loginForm.key">
                      我已阅读并接受
                      <router-link tag="span" to="agreement" class="yellow">用户协议</router-link>
                      和
                      <router-link tag="span" to="agreement" class="yellow">隐私政策</router-link>
                    </el-checkbox>
                  </el-col>
          ...
          <el-tab-pane label="密码登录" name="password">
            <el-form ref="pswform" :model="pswform">
              <el-form-item prop="userName">
                <el-input v-model="pswform.userName" placeholder="请输入手机号"></el-input>
              </el-form-item>
              ...
              <el-form-item prop="code" class="code-wrapper">
                <el-row :span="24" :gutter="15">
                  <el-col :span="14">
                    <el-input placeholder="请输入验证码" v-model="pswform.code"></el-input>
                  </el-col>
                  <el-col :span="8" :offset="2">
                    <div class="login-code" @click="pswCode">
                      <Sidentify1
                        @click="pswCode"
                        :identifyCode="psCode"
                        style="width:120px;border-radius: 4px;overflow: hidden;"
              ...
              <el-form-item class="submit-wrapper">
                <el-button class="submit" type="primary" @click="submitFormpwa('pswform')">登录</el-button>
              </el-form-item>
              <el-form-item class="desc-wrapper">
                <el-row :span="24" :gutter="17">
                  <el-col :span="14">
                    <el-checkbox v-model="savepaw" style="color:#a0a0a0;">记住密码</el-checkbox>
                  </el-col>
                  <el-col :span="8" :style="{textAlign:'right'}" :offset="2">
                    <router-link to="/" class="text-wrapper">忘记密码</router-link>
                  </el-col>
                </el-row>
              </el-form-item>
            </el-form>
...
import Sidentify1 from "@/components/Sidentify";
export default {
  components: {
    Sidentify,
    Sidentify1
  ...
  methods: {
    ...
    makeCodes(o, l) {
      for (let i = 0; i < l; i++) {
        this.psCode += this.psCodes[this.randomNum(0, this.psCodes.length)];
      }
      console.log(this.psCode);
    },
